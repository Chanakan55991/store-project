...
<head>
  ...
  <body class='bg-[antiquewhite] h-screen'>
    ...
    <span class='text-2xl font-bold mb-4'>คนส๊วย (คีมลูกคีม)</span>
    <img class='border-2 border-black' src="assets/logo.png"  />
...
และ มีขนาดเล็ก เหมาะกับการใช้งานในที่แคบ และ งานไฟฟ้า</span>
    ...
    <div class='flex gap-4 mt-8'>
        <sl-button>ย้อนกลับ</sl-button>
        <sl-button>ตกลง</sl-button>
    </div>
